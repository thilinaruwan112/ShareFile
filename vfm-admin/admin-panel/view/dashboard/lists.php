                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="row mb-2">
                            ...
                            <div class="col-12 mb-2">
                                <?php $formchecked = $setUp->getConfig('list_view') == 'grid' ? ' checked' : ''; ?>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-2">
                                <?php $formchecked = $setUp->getConfig('filedeforder') == 'alpha' ? ' checked' : ''; ?>
                                <div class="form-check form-check-inline">
                                ...
                                <?php $formchecked = $setUp->getConfig('filedeforder') !== 'date' ? ' checked' : ''; ?>
                                <div class="form-check form-check-inline">
                                ...
                                <?php $formchecked = $setUp->getConfig('filedeforder') !== 'size' ? ' checked' : ''; ?>
                                <div class="form-check form-check-inline">
                        ...
                        <div class="row toggled">
                            ...
                            <div class="col-12 mb-2">
                                <?php $formchecked = $setUp->getConfig('filedefnum') == 10 ? ' checked' : ''; ?>
                                <div class="form-check form-check-inline">
                                ...
                                <?php $formchecked = $setUp->getConfig('filedefnum') == 25 ? ' checked' : ''; ?>
                                <div class="form-check form-check-inline">
                                ...
                                <?php $formchecked = $setUp->getConfig('filedefnum') == 50 ? ' checked' : ''; ?>
                                <div class="form-check form-check-inline">
                                ...
                                <?php $formchecked = $setUp->getConfig('filedefnum') == 100 ? ' checked' : ''; ?>
                                <div class="form-check form-check-inline">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-2">
                                <?php $formchecked = $setUp->getConfig('folderdeforder') == 'alpha' ? ' checked' : ''; ?>
                                <div class="form-check form-check-inline">
                                ...
                                <?php $formchecked = $setUp->getConfig('folderdeforder') !== 'date' ? ' checked' : ''; ?>
                                <div class="form-check form-check-inline">
                        ...
                        <div class="row toggled">
                            ...
                            <div class="col-12 mb-2">
                                <?php $formchecked = $setUp->getConfig('folderdefnum') == 5 ? ' checked' : ''; ?>
                                <div class="form-check form-check-inline">
                                ...
                                <?php $formchecked = $setUp->getConfig('folderdefnum') == 10 ? ' checked' : ''; ?>
                                <div class="form-check form-check-inline">
                                ...
                                <?php $formchecked = $setUp->getConfig('folderdefnum') == 25 ? ' checked' : ''; ?>
                                <div class="form-check form-check-inline">
                                ...
                                <?php $formchecked = $setUp->getConfig('folderdefnum') == 50 ? ' checked' : ''; ?>
                                <div class="form-check form-check-inline">
