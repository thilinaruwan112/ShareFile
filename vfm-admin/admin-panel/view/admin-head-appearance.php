...
if (isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Color scheme
    $color_primary = filter_input(INPUT_POST, '--color-primary', FILTER_SANITIZE_STRING);
    $color_dark = filter_input(INPUT_POST, '--color-dark', FILTER_SANITIZE_STRING);
    $color_light = filter_input(INPUT_POST, '--color-light', FILTER_SANITIZE_STRING);
